...
Digite o número correspondente à sua escolha: """))
    ...
    if vida_jogador1 <= 0:
        ...
        print("✦ .  ⁺   . ✦ .  ⁺   . ✦ .  ⁺   . ✦ .  ⁺   .  ✦ .  ⁺   . ✦ .  ⁺   . ✦ .  ⁺   . ✦ .  ⁺   . ✦  .  ⁺   . ✦ .  ⁺   . ✦  .  ⁺   . ✦ .  ⁺   . ✦")
        print("")
        vencedor = nome_jogador_2
        perdedor = nome_jogador_1
        ...
        print("✦ .  ⁺   . ✦ .  ⁺   . ✦ .  ⁺   . ✦ .  ⁺   .  ✦ .  ⁺   . ✦ .  ⁺   . ✦ .  ⁺   . ✦ .  ⁺   . ✦  .  ⁺   . ✦ .  ⁺   . ✦  .  ⁺   . ✦ .  ⁺   . ✦")
        print("")
        vencedor = nome_jogador_1
        perdedor = nome_jogador_2
...
def jogo():
    ...
    vencedor, perdedor = batalha(vida_jogador1, stats_jogador1, vida_jogador2, stats_jogador2)
    return vencedor, perdedor
    
#Usando a função para iniciar o jogo
vencedor, perdedor = jogo()
with open("log.txt", "a") as log:
  log.write(f"O vencedor foi: {vencedor}, e o derrotado foi: {perdedor} \n")

#Function to extract names from the txt file
def extrair_nomes():
    vencedores = []
    derrotados = []
    ...
    with open("log.txt", "r") as arquivo:
        for linha in arquivo:
            ...
            # Divide a linha em partes usando a vírgula e o delimitador
            partes = linha.split(", e o derrotado foi: ")
            vencedor = partes[0].split("O vencedor foi: ")[1]  # Pega o nome do vencedor
            derrotado = partes[1]  # Pega o nome do derrotado
            
            vencedores.append(vencedor)
            derrotados.append(derrotado)

    return vencedores, derrotados

quer = int(input("você quer a lista de vencedores e perdedores? digite 1 para sim "))
if quer == 1:
    vencedores, derrotados = extrair_nomes()
